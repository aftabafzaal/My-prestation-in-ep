...
<td width="59%" height="419" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="529">
          <tbody>
            ...
            <tr>
              ...
              <td width="25%"><span class="greensmalltext">Product</span></td>
              <td width="56%"><span class="greensmalltext">Description</span></td>
              <td class="greensmalltext" width="11%"><div align="center">Price</div></td>
              <td class="greensmalltext" width="2%">&nbsp;</td>
            </tr>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px dotted gray;padding-top: 20px" class="smalltext-black" valign="top">&nbsp;</td>
            </tr>
            ...
            -->
              ...
              <td bgcolor="#F2F2F2"><div align="right"><strong class="blacksmalltext">Sub-Total</strong></div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black"><div id="sub_total" align="right">0.00</div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black">&nbsp;</td>
                </tr>
            <tr>
              <td bgcolor="#F2F2F2">&nbsp;</td>
              <td height="25" bgcolor="#F2F2F2">&nbsp;</td>
              <td bgcolor="#F2F2F2"><div align="right"><strong class="blacksmalltext">Shipping &amp; Handling</strong></div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black"><div align="right" id="ship_amt"><?php print SHIP_AMT; ?></div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black">&nbsp;</td>
            </tr>
            <tr>
              <td bgcolor="#F2F2F2">&nbsp;</td>
              <td height="25" bgcolor="#F2F2F2">&nbsp;</td>
              <td bgcolor="#F2F2F2"><div align="right"><strong class="blacksmalltext">Free Trial + S&amp;H Total</strong></div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black"><div class="red-text" align="right" id="tot_amt">$ <?php print SHIP_AMT; ?></div></td>
              <td bgcolor="#F2F2F2" class="smalltext-black">&nbsp;</td>
            </tr>
            <tr>
              <td height="5" colspan="5" bgcolor="#F2F2F2" style="border-bottom: 1px dotted gray; padding-top: 5px;">&nbsp;</td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td height="25">&nbsp;</td>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px dotted gray; padding-top: 20px; padding-bottom: 20px;" align="left" valign="top"><span class="purpletext">Instant EnVisage FACELIFT SERUM!</span>
                <span class="purpletext2">&quot;Plastic Surgery in a Bottle.&quot;</span><br />
                <?php 
              ...
              ?>
                ...
                <p class="smalltext-black2">This extraordinary skin solution tightens sagging skin to visibly lift as it smoothes creases and wrinkles. The results are amazing and last between six to eight hours.</p>
                <p><span class="smalltext-black2">By combining Equinox with Envisage Facelift Serum you can create an even more powerful solution to reach your anti aging goals faster! </span> </p>
                <ul>
                  <li class="smalltext-black2">Smoothes creases &amp; wrinkles</li>
                  <li class="smalltext-black2">Tightens and visibly lifts agging skin</li>
                  <li class="smalltext-black2">Ideal for dinner parties, meetings and special occasions<br />
                    <br />
                  </li>
                </ul>
              ...
              <td style="border-bottom: 1px dotted gray; padding-top: 20px; padding-bottom: 20px;" valign="top" class="smalltext-black">&nbsp;</td>
            </tr>

            <tr>
              <td height="14" colspan="5" align="center" valign="middle">&nbsp;</td>
            </tr>
            <tr>
              <td height="14" colspan="5" align="center" valign="middle"><div class="blacksmalltext" align="justify">
            ...
            <tr>
              <td height="14" colspan="5" align="center" valign="middle"><br /></td>
            </tr>
          </tbody>
        </table></td>
