<? require_once("./include/billinginfo_discount_code.php"); 
...
<title>Enter your payment information | Special Discount Page - EnVisage Facelift Serum</title>
...
function Calculate_Amt() {
    ...
    var tot_amt = <?=SHIP_DISCOUNT_AMT?>;
    var ship_amt = <?=SHIP_DISCOUNT_AMT?>;
	var upsell_1 = 29.99;
	// var upsell_2 =0.00;
    var upsell_product_name = '';
    var upsell_product_price = '';

	var final_tot = <?=SHIP_DISCOUNT_AMT?>;
...
<table width="586" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        ...
                        <tr>
                          <td height="51" colspan="2" bgcolor="#421562"><div align="left" class="white_font" style="padding:5px 0px 0px 5px;">GET RESULTS EVEN FASTER!<br />
                          </div>
                          ...
                          <td height="51" align="left" valign="middle" bgcolor="#421562"><div align="left" class="white_font" style="padding-left:34px;"><span class="white_font2">
                          <label class="white_font2" style="font-weight: bold;">ADD</label>
                                <input type="checkbox" name="billing_upsell" id="billing_upsell" value="1" <?php //print $billing_upsell_checked; ?> />
                          
                          </span></div></td>
                        </tr>
                        <tr>
                          <td width="147" height="230"><div align="center"><img src="<?php print WEB_ROOT; ?>images2/Bottle_Envisage.png" width="105" height="194" /></div></td>
                        <td width="329" valign="top"><h2><br />
                            ...
                            <br />
                              ...
                              <tr>
                                <td width="6%" height="24" align="center" valign="middle"><img src="<?php print WEB_ROOT; ?>images2/bullet-meal3.png" width="11" height="11" /></td>
                              ...
                              <tr>
                                <td width="6%" height="23" align="center" valign="middle"><img src="<?php print WEB_ROOT; ?>images2/bullet-meal3.png" width="11" height="11" /></td>
                ...
                <tr>
                  <td><table width="99%" border="0" cellspacing="2" cellpadding="1">
                    <tr>
                      ...
                      <td colspan="2" class="black_font"><?php print PRODUCT_NAME; ?></td>
...
-->                    
                    ...
                    <tr>
                      ...
                      <td align="right"><div class="gray_font" align="right" id="ship_amt">$<?php print SHIP_DISCOUNT_AMT; ?></div></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td align="right" valign="bottom"><span class="red_font" id="tot_amt">$<?=SHIP_DISCOUNT_AMT?></span></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
      ...
      <div id="guaranteebox">
                ...
                <div id="termstext"><p>Money Back Guarantee Terms: Start your risk-free trial today, and we'll send you a full 30-day supply of the <?php print PRODUCT_NAME; ?>. Just pay <?php print SHIP_AMT; ?> for S&P. You have 14 days to try the product and discover why <?php print PRODUCT_NAME; ?> is the right anti-aging treatment for you. If you enjoy the product, do nothing, you'll be billed the low, low price of just $99.00 at the end of your trial period. In the unlikely event you decide that <?php print PRODUCT_NAME; ?> is not the perfect wrinkle-fighting system, call us toll-free at <?php print SITE_PH_NO; ?> any time during your 14-day trial period to cancel your trial, then simply return the product (even if it is empty!) and you will NEVER be billed. Plus, if you decide to keep <?php print PRODUCT_NAME; ?>, you will receive FREE acceptance in our Elite autoship Program, and you'll receive a new supply of <?php print PRODUCT_NAME; ?> every 30 days at the same low Elite autoship price of <?php print TOTAL_AMOUNT; ?>. Sales tax may be added to some orders depending on where you live You can cancel anytime! Please&nbsp;<a href="#">read our terms and conditions&nbsp;</a>for more details</p>
          </div><br />
...
<tr>
  ...
  <tr height="30">
                  ...
                  <tr>
                    <td colspan="2">
                        <div id="pinfo" style="display: block;">
...
<input type="checkbox" name="term" value="1" checked="checked" />
<!-- I agree to the  	
...
of this site.-->
<div style="font-size: 8pt; display:inline">By submitting my information, I represent and warrant that I am 18 years of age or older, and have read and agreed to the <a href="javascript:void(0)" onclick="MM_openBrWindow('terms_conditions.php','Terms','scrollbars=yes,width=565,height=600')" class="footer2">Terms &amp; Conditions</a> and <a href="javascript:void(0)" class="footer2" onclick="MM_openBrWindow('privacy_policy.html','PrivacyPolicy','scrollbars=yes,width=585,height=600')">Privacy Policy</a> of this site.</div>
</div> 	
