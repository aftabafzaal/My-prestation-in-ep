                  ...
                  <tbody>
                    ...
                    <tr>
                      <td height="53" colspan="2" align="center" class="cvvText"><div align="center" class="formText">
                        <div align="justify"><span class="footer-text">To help you get started, we offer a 14-days trial of <?php print PRODUCT_NAME; ?> with the  eligibility of automatic enrollment in our home delivery program. You can try <?php print PRODUCT_NAME; ?> risk free to  determine for yourself, if this product is right for you. When you submit your  order, you automatically agree to pay the non-refundable discounted shipping  &amp; handling cost of $<?php print SHIP_AMT; ?> for your trial for a full 30 day supply of <?php print PRODUCT_NAME; ?>. <br />
                            <br />
If you  find that the product is not right for you, simply call our Customer Support  Center   or the numbers shown on your bank statement you can also send an email to cancel your membership before the end of your 14-day trial period and you  will not be charged the full price of the <?php print PRODUCT_NAME; ?>. Your  14-day trial period begins at the date of  order our products are normally delivered within 3 to 5 business days from the  time of ordering. If you do not receive your trial bottles within five (5) business  days of placing the order, please contact our Customer Service Center or numbers  shown on your bank statement our support staff is available to give you more  updated information on the estimated delivery time along with the tracking info.  </span></div>
                      </div></td>
                    </tr>
                    <tr>
...
.
    ...
    <div id="footer" style="padding-top:115px;">
